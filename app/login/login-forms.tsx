  ...
  const GoogleButton = () => (
    <div className="flex flex-col gap-4 w-full">
      ...
      <Button
        ...
        className="h-11 rounded-full border-border bg-background font-sans text-[10px] font-medium uppercase tracking-[0.2em] transition-all hover:bg-muted/50 w-full flex items-center justify-center gap-2"
      >
